        ...
        <div className='text-start '>
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary submit">Reset Filter</button>
                </div>
            </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" onClick={()=> handleSubmit(brand.brand_id)} class="btn btn-primary">Update</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
